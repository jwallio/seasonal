...
def main() -> int:
    ...
    for term in (
        ...
        "site\\cfsv2_manifest.json",
        "site\\superensemble_manifest.json",
    ):
    ...
    check("pages-payload\\analog_products" in workflow, "flat analog payload must copy product contents without an extra directory level")
