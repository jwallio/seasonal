...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--lead-months", default="3,4,5", help="target offsets from the NASA release month")
    parser.add_argument("--seasonal-window", default="3,4,5", help="consecutive offsets for an additional seasonal map")
