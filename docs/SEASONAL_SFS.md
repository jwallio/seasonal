...
boundaries. Monthly snowfall depth-departure maps use the shared −14 to +14-inch
scale; seasonal totals use −20 to +20 inches. Values outside the endpoints use
distinct darker rectangular overflow cells.
